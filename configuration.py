...
def attachSensorsToVehicle(world, data, vehicle_actor):
    ...
    for i in range(len(data['sensors'])):
        ...
        if sensor["type"] == "sensor.lidar.ray_cast_semantic":
            ...
            print ("LIDAR INFO")
            print ("=================================================")
            print ("TRANSFORM the points from lidar space to world space = ", lidar_2_world)
            print ("=================================================")
        ...
        if sensor["type"] ==  "sensor.camera.rgb":
            ...
            world_2_camera = np.array(sensor_actor.get_transform().get_inverse_matrix())
...
def createOutputDirectories(data):
    ...
    output_sensor_folders = [ data['sensors'][i]['role_name'] for i in range(len(data['sensors'])) ]
    try:
        os.mkdir("out/")
    except OSError:
        pass
